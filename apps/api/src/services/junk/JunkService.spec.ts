...
describe("JunkService", () => {
    const junkEmailsAddress: Array<string> = [
        ...
        "renewMSWyY@pedacosdavida.com",
        "reneweTrvV@pedacosdavida.com",
        "newslettersbartlanguageww@bartlanguage.com",
        "outlet@zexevo.com",
        "outlet@tukevo.com",
        "outlet@yukevo.com",
        "outlet@juxevo.com",
        ...
        "winter.nguyen@rxvfitmz.onmicrosoft.com",
        "hello@historyquiz.com",
        "rowan.gonzalez@plikhockeyplaying.onmicrosoft.com",
        "max.rivera@plikhockeyplaying.onmicrosoft.com",
    ];
